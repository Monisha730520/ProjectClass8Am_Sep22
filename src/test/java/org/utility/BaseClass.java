...
//	20
	public static void getScreenshortAs(String name) throws IOException {
		...
		File to=new File(System.getProperty("user.dir")+"\\src\\test\\resources\\screenshot\\"+name+".png");
...
//
//		//File Path
//		File loc=new File("C:\\Users\\Asus\\eclipse-workspace\\TestngProject\\src\\test\\resources\\"+filename+".xlsx");
//		//File InputStrem
